...
public class JdbcPage<E> extends AbstractPage<E> {
	 ...
	 */
	public JdbcPage(ResultSet rs, int pageNumber, int pageSize, IRowHandler<E> rh) {
	 ...
	 * @param rh Row data handler.
	 */
	public JdbcPage(ResultSet rs, int totalCount, int pageNumber, int pageSize, IRowHandler<E> rh) {
		super(pageNumber, pageSize);
		try {
